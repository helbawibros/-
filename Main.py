...
# --- نموذج الحبوب ---
    ...
    with st.expander("📦 تعبئة 1000غ / 907غ"):
        # تم تعديل الأوزان بناءً على طلبك بدقة
        render_list([
            ...
            "-ارز", "ارز مصري (907غ)", "ارز إيطالي (907غ)", "ارز اميركي (907غ)", "ارز بسمتي (907غ)", "ارز عنبري (1000غ)", "ارز ناعم (907غ)", 
...
# --- نموذج البهارات (تمت مطابقتها مع الصور) ---
