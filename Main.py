...
st.markdown("""
    ...
    .stNumberInput label { color: #333 !important; font-size: 16px; font-weight: bold; }
    input { background-color: #ffffcc !important; font-weight: bold !important; height: 40px !important; font-size: 18px !important; }
    ...
    /* تنسيق لعنوان الـ Expander */
    .streamlit-expanderHeader { font-size: 20px !important; font-weight: bold !important; color: #1E3A8A !important; }
    </style>
...
# --- نموذج الحبوب المطور بالقوائم المنزلقة ---
    ...
    if st.button("🚀 إرسال الطلبية الكاملة", use_container_width=True):
        if customer and full_order:
            ...
            st.warning("يرجى إدخال اسم الزبون وتعبئة الأصناف المطلوبة")
