...
st.markdown("""
    ...
    .category-header { 
        background-color: #e9ecef; color: #1E3A8A; padding: 8px 15px; border-radius: 5px; 
        font-weight: bold; font-size: 18px; margin-top: 10px; border-right: 5px solid #fca311; text-align: right;
    }
    ...
    input { 
        ...
        height: 45px !important; font-size: 22px !important; -webkit-text-fill-color: black !important;
    }
...
# --- نموذج الحبوب المحدث بالعناوين الجديدة ---
