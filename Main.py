...
st.markdown("""
    ...
    /* تنسيق العناوين الفرعية الرمادية */
    .category-header { 
    ...
    /* خانات الإدخال صفراء بخط أسود عريض */
    input { 
...
# --- نموذج البهارات ---
    ...
    # القسم الأول 50غ
    st.markdown('<div class="section-title">بهارات ناعمة 50 غ دزينة</div>', unsafe_allow_html=True)
    ...
    # القسم الثاني 50غ خاصة
    st.markdown('<div class="section-title">بهارات خاصة (50 غرام)</div>', unsafe_allow_html=True)
