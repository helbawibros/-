        ...
        if item.startswith("-"):
            ...
            with c2:
                ...
                if q > 0: 
                    ...
                    order_dict[section_label].append(f"{item}: {q}")
...
# --- نموذج الحبوب ---
    ...
    with st.expander("📦 تعبئة 1000غ / 907غ"):
        render_list([
            ...
            "-ارز", "ارز مصري (907غ)", "ارز إيطالي (907غ)", "ارز amirki (907غ)", "ارز بسمتي (907غ)", "ارز عنبري (1000غ)", "ارز ناعم (907غ)", 
            "-سكر", "سكر حب (907غ)", "سكر اسمر (1000غ)", "سكر ناعم (1000غ)", 
            "-طحين", "طحين فرخة (907غ)", "سميد (907غ)", "غود ميدل (1000غ)", "غودمارك (907غ)", "طحين زيرو (1000غ)", "طحين فقش (1000غ)", "طحين اسمر (1000غ)", "طحين ذره (1000غ)", 
            "-زعتر", "زعتر محوج (1000غ)", "زعتر اكسترا (1000غ)", 
            "-ترمس", "ترمس حلو (1000غ)", "ترمس مر (1000غ)",
            "-قمح", "قمح مقشور (907غ)", "قمح بقشرو (907غ)",
            "-مختلف", "فريك مجروش (1000غ)", "مغربيه (907غ)", "ذرة بوشار (1000غ)", "ذره مجروشه (1000غ)"
        ], "g1k", full_order, "قسم 1000غ/907غ")

    with st.expander("📦 تعبئة 500غ / 454غ"):
        render_list([
            "-سمسم", "سمسم مقشور", "سمسم محمص", "سمسم بلدي محمص", "-نشاء", "نشاء ناعم", "نشاء حب", "-زعتر", "زعتر محوج", "زعتر اكسترا", "زعتر حلبي", "-اكل عصفور", "بسيبيسة مشكله", "بسيبيسه ساده", "قمبز", "دخن", "بزر ميال الشمس", "-علب", "مغلي جاهز", "مغلي بدون سكر", "مهلبيه", "مهلبيه ظرف", "سحلب", "خلطة كرسبي", "خلطة بروستد", 
            "-ذره", "ذره بوشار (454غ)", "ذره مجروشه (500غ)", 
            "-ترمس", "ترمس حلو (500غ)", "ترمس مر (500غ)",
            "-سكر", "سكر ناعم", "سكر نبات", "سكر اسمر", "-شوفان", "شوفان مبروش", "شوفان حب", "-مختلف", "فاصوليا عريضة", "فريك مجروش", "فول عريض", "برش الهند", "أرز ناعم", "كشك", "ملوخيه", "كعك مطحون", "خميرة باكيت", "كاكاو", "طحين ذرة", "بزر كتان"
        ], "g500", full_order, "قسم 500غ/454غ")

    with st.expander("📦 تعبئة 200غ"):
        render_list(["-سمسم", "مقشور", "محمص", "محمص بلدي", "-نشاء", "حب", "ناعم", "-فرمسيل", "شوكولا", "ملون", "-ملوخية", "نايلون", "كرتون", "-زعتر", "محوج", "حلبي", "-مختلف", "برش جوز الهند", "بامية زهرة", "فلافل علب", "كشك بلدي", "بطاطا شيبس", "كاكاو", "كعك مطحون", "بزر كتان"], "g200", full_order, "قسم 200غ")
    
    with st.expander("📋 تعبئة مختلفة"):
        render_list(["-سكر نبات", "100 غ × 12", "200 غ × 12", "-ملح", "ناعم 700 غ × 24", "ناعم 3 كلغ × 6", "خشن 1 كلغ × 12", "-علب", "فانيليا 20 غ × 12", "باكينغ بودر 20 غ × 12", "-كرتون", "صنوبر × 12", "مسكة حب × 25", "-سمسم", "مقشور 100 غ × 12", "محمص 100 غ × 12", "-زهورات", "زهورات 100 غ × 12", "زهورات 200 غ × 12", "-قمح", "مقشور 2 كلغ", "مقشور 5 كلغ", "-مختلف", "بابونج 100 غ × 12", "بطاطا شيبس 100 غ", "بامية زهرة 100 غ", "كاكاو 100 غ"], "gmisc", full_order, "قسم مختلف")
